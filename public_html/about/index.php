    ...
    <div class="container">
        ...
        <main>
            <section class="section-card">
                <h2>About</h2>
                <div class="about">
                    <p style="font-size: 20px">KoPickUp is a project in collaboration with Koperasi Politeknik Seberang
                        Perai. Our platform helps students easily track and collect their parcels at the Koperasi,
                        making the process faster and more convenient.</p>
                </div>
            </section>
        </main>
